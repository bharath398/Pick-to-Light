...
void can_transmit(void)
{
	...
	TXB0D0 = E_UST[0];			/* DataByte 0 */
	TXB0D1 = E_UST[1];			/* DataByte 1 */
	TXB0D2 = E_UST[2];			/* DataByte 2 */
	TXB0D3 = E_UST[3];			/* DataByte 3 */
	TXB0D4 = E_PID[0];			/* DataByte 4 */
	TXB0D5 = E_PID[1];			/* DataByte 5 */
	TXB0D6 = E_PID[2];			/* DataByte 6 */
	TXB0D7 = E_PID[3];			/* DataByte 7 */
